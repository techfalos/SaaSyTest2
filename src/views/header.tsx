...
export default function GeneratedHeaderView(){
  return (
    <div className="h-full gap-4 grid  grid-flow-col relative" style={{ backgroundColor: '#000000', paddingLeft: '5px', paddingRight: '10px', paddingTop: '2px', maxHeight: '100px', display: 'grid', placeItems: 'center center' }}>
            ...
            <div className="h-full w-full col-span-2 md:col-span-1 lg:col-span-7" style={{ backgroundColor: '#000000', paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px', paddingBottom: '8px', display: 'grid', placeItems: 'center center', textAlign: 'center', justifyContent: 'center' }}>
              <div className="w-full h-full flex flex-col justify-center items-center">
                <GeneratedHeaderMenuView_825d5e />
              </div>
            </div>
            <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-1" style={{ backgroundColor: '#000000', display: 'grid', placeItems: 'center end', textAlign: 'right', justifyContent: 'end' }}>
