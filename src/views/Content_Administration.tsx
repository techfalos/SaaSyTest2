...
const ContentAdministrationView = function () {
...
ContentAdministrationView.displayName = 'ContentAdministrationView';
export default ContentAdministrationView;