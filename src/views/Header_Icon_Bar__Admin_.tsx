...
export default function HeaderIconBarAdminView() {
  const router = useRouter();
  const customViewDescription = "[{\"icon\":\"mail\",\"text\":\"Contact\",\"pageId\":\"contact\"}]";
  const align = 'Right';
  ...
  const handleClick = (pageId: string) => {
    ...
    const pages = [{"id":"c6ed7b1e-f82a-486e-884f-5640c0022579","name":"Dashboard"},{"id":"6d5054b9-94b1-4a33-87ae-5e7e5712db09","name":"Admin Dashboard"},{"id":"home","name":"Home"},{"id":"menu","name":"Menu"},{"id":"order_online","name":"Order Online"},{"id":"shopping_cart","name":"Shopping Cart"},{"id":"checkout","name":"Checkout"},{"id":"order_confirmation","name":"Order Confirmation"},{"id":"order_history","name":"Order History"},{"id":"order_details","name":"Order Details"},{"id":"locations","name":"Locations & Schedule"},{"id":"about","name":"About Us"},{"id":"contact","name":"Contact"},{"id":"catering","name":"Catering Services"},{"id":"admin_orders","name":"Order Management"},{"id":"admin_menu","name":"Menu Management"},{"id":"admin_locations","name":"Location Management"},{"id":"admin_customers","name":"Customer Management"},{"id":"008c67f7-2a1d-4e08-a5dd-59d024a6fa5b","name":"Terms of Service"},{"id":"552eea5a-70ae-417e-bdee-9c63a805e564","name":"Privacy Policy"},{"id":"ac01e8ce-c52e-435a-aa7f-68539070cf6d","name":"Login"}];
