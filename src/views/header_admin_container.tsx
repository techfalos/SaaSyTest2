...
import GeneratedHeaderAdminView_db41bb from './header_admin';
import GeneratedHeaderIconBarAdminView_b9d101 from './header_icon_bar_admin';
import GeneratedHeaderLoginView_f3cf76 from './header_login';

export default function GeneratedHeaderAdminContainerView(){
  return (
    <div className="h-full gap-4 grid  grid-flow-col relative" style={{ paddingLeft: '5px', paddingRight: '10px', paddingTop: '2px', borderBottomWidth: '1px', borderBottomStyle: 'solid', borderColor: '#404040' }}>
            ...
            <div className="h-full w-full col-span-2 md:col-span-1 lg:col-span-7" style={{ paddingLeft: '24px', paddingRight: '24px', paddingTop: '24px', paddingBottom: '24px', alignContent: 'center', textAlign: 'center' }}>
              <div className="w-full h-full flex flex-col justify-center items-center">
                <GeneratedHeaderAdminView_db41bb />
              </div>
            </div>
            <div className="h-full w-full col-span-1 md:col-span-1 lg:col-span-1" style={{ paddingLeft: '24px', paddingRight: '24px', paddingTop: '24px', paddingBottom: '24px', alignContent: 'center', textAlign: 'right' }}>
              <div className="w-full h-full flex flex-col justify-center items-end">
                <GeneratedHeaderIconBarAdminView_b9d101 />
              </div>
            </div>
