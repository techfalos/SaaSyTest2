...
const SessionAdministrationView = function AdminSessionsDashboard() {
...
SessionAdministrationView.displayName = 'SessionAdministrationView';
export default SessionAdministrationView;