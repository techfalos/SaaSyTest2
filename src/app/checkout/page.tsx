...
import GeneratedCheckoutFormView from '../../views/checkout_form';
...
export const metadata: Metadata = { title: "Checkout", description: "Complete purchase with shipping and payment" };
