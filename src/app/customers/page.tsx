...
import GeneratedCustomerManagerView from '../../views/customer_manager';
...
export const metadata: Metadata = { title: "Customers", description: "Manage customer accounts and data" };
