...
import GeneratedProductDetailsView from '../../views/product_details';
...
export const metadata: Metadata = { title: "Item Detail", description: "Detailed view of a specific Victorian dress" };
