...
import GeneratedServicesOverviewView from '../../views/services_overview';
import GeneratedWeddingFilmsView from '../../views/wedding_films';
import GeneratedCorporateVideosView from '../../views/corporate_videos';
import GeneratedCommercialsView from '../../views/commercials';
...
export const metadata: Metadata = { title: "Services", description: "Overview of videography services offered" };
      ...
      <main>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '20px', display: 'grid', alignContent: 'start', textAlign: 'center' }}>
                          <div className="w-full h-full flex flex-col">
                            <GeneratedServicesOverviewView isContainer={false} />
                          </div>
                        </div>
                    </div>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '20px', display: 'grid', alignContent: 'start', textAlign: 'left' }}>
                          <div className="w-full h-full flex flex-col">
                            <GeneratedWeddingFilmsView isContainer={false} />
                          </div>
                        </div>
                    </div>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '20px', display: 'grid', alignContent: 'start', textAlign: 'left' }}>
                          <div className="w-full h-full flex flex-col">
                            <GeneratedCorporateVideosView isContainer={false} />
                          </div>
                        </div>
                    </div>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '20px', display: 'grid', alignContent: 'start', textAlign: 'left' }}>
                          <div className="w-full h-full flex flex-col">
                            <GeneratedCommercialsView isContainer={false} />
                          </div>
                        </div>
                    </div>
