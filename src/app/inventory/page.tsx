...
import GeneratedInventoryManagerView from '../../views/inventory_manager';
...
export const metadata: Metadata = { title: "Inventory", description: "Manage product catalog and stock" };
