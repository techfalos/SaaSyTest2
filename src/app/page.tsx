...
import GeneratedHeroSlideshowView from '../views/hero_slideshow';
import GeneratedAboutOurCollectionView from '../views/about_our_collection';
...
export const metadata: Metadata = { title: "Home", description: "Welcome page showcasing Victorian era fashion collections" };
  ...
  return (
    <div className="page" style={{ minHeight: '70vh' }}>
      <main>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ color: '#ffffff', minHeight: '520px', borderBottomWidth: '1px', borderBottomStyle: 'solid', borderColor: '#ffffff' }}>
                            <GeneratedHeroSlideshowView />
                        </div>
                    </div>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '20px', alignContent: 'start', textAlign: 'center' }}>
                            <GeneratedAboutOurCollectionView isContainer={false} />
                        </div>
                    </div>
