...
import GeneratedProcessingPaymentView from '../../views/processing_payment';
...
export const metadata: Metadata = { title: "Payment", description: "Payment processor callback handler" };
  ...
  return (
    <div className="page" style={{ minHeight: '70vh' }}>
      <main>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ marginLeft: '25px', marginRight: '25px', marginTop: '25px', marginBottom: '25px', alignContent: 'center', textAlign: 'center' }}>
                            <GeneratedProcessingPaymentView />
                        </div>
                    </div>
