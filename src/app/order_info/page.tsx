...
import GeneratedOrderDetailsView from '../../views/order_details';
...
export const metadata: Metadata = { title: "Order Info", description: "Detailed view of specific order" };
