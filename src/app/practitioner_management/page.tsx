...
import GeneratedHeaderAdminView_78758a from '../../views/header_admin';
import GeneratedPractitionerAdministrationView from '../../views/practitioner_administration';
import GeneratedFooterMenuView from '../../views/footer_menu';
import GeneratedCopyrightView from '../../views/copyright';

export const metadata: Metadata = { title: "Practitioner Management", description: "Admin interface for managing practitioner profiles" };
      ...
      <main>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ paddingLeft: '5px', paddingRight: '10px', paddingTop: '2px', display: 'grid', placeItems: 'center center' }}>
                          <div className="w-full">
                            <GeneratedHeaderAdminView_78758a />
                          </div>
                        </div>
                    </div>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px', paddingBottom: '8px', display: 'grid', placeItems: 'start center' }}>
                          <div className="w-full">
                            <GeneratedPractitionerAdministrationView />
                          </div>
                        </div>
                    </div>
