...
import ClientSuccessStoriesView from '@/views/Client_Success_Stories';
import FooterMenuView from '@/views/Footer_Menu';
import CopyrightView from '@/views/Copyright';

export const metadata: Metadata = {
    title: 'Testimonials',
    description: 'Client testimonials and healing success stories',
    openGraph: {
        title: 'Testimonials',
        description: 'Client testimonials and healing success stories',
        url: '/testimonials',
    ...
    return (
        <div className="page" style={{ minHeight: '75vh' }}>
            <main>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12 view-testimonials_showcase-title" style={{ color: '#ffffff', paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px', paddingBottom: '8px', display: 'grid', placeItems: 'center center' }}>
                          <div className="w-full">
                            <ErrorBoundary fallback={<Error />}>
                                <ClientSuccessStoriesView />
                            </ErrorBoundary>      </div>
                        </div>
                    </div>
                    <div className="h-full gap-4 grid grid-cols-12 relative">
