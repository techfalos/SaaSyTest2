...
import GeneratedShoppingCartView from '../../views/shopping_cart';
...
export const metadata: Metadata = { title: "Cart", description: "Review items before checkout" };
