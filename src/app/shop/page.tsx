...
import GeneratedProductListingView from '../../views/product_listing';
...
export const metadata: Metadata = { title: "Shop", description: "Browse products from selected collection" };
