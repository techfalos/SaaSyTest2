...
import GeneratedPortfolioIntroductionView from '../../views/portfolio_introduction';
import GeneratedVideoShowcaseView from '../../views/video_showcase';
...
export const metadata: Metadata = { title: "Portfolio", description: "Video gallery showcasing completed videography projects" };
      ...
      <main>
                    ...
                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '20px', display: 'grid', alignContent: 'start', textAlign: 'center' }}>
                          <div className="w-full h-full flex flex-col">
                            <GeneratedPortfolioIntroductionView isContainer={false} />
                          </div>
                        </div>
                    </div>

                    <div className="h-full gap-4 grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ paddingLeft: '25px', paddingRight: '25px', paddingTop: '25px', paddingBottom: '25px', display: 'grid', alignContent: 'start', textAlign: 'left' }}>
                          <div className="w-full h-full flex flex-col">
                            <GeneratedVideoShowcaseView />
                          </div>
                        </div>
                    </div>
