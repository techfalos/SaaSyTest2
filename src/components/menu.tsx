...
const menus: MenuItem[][] = [
  [
    ...
    {
      "name": "Tree Farm Locations",
      "link": "/tree_farm_locations"
    },
    {
      "name": "Board Members",
      "link": "/board_members"
  ...
  [
    ...
    {
      "name": "My Event Registrations",
      "link": "/my_event_registrations"
    },
    {
      "name": "Tree Farm Locations",
      "link": "/tree_farm_locations"
...
interface MenuProps {
  menuType: 'header' | 'headerauth' | 'headeradmin' | 'profile' | 'footer' | 'custom';
  menuIndex?: number;
...
export default function Menu({ menuType, menuIndex, direction = 'horizontal', hasAuth, hasUserTier, onClick }: MenuProps) {
  ...
  const renderMenuItem = (item: MenuItem, index: number) => {
    ...
    const isHeader = menuType === 'header' || menuType === 'headerauth' || menuType === 'headeradmin';
